...
class APIMethodProvider extends BaseAPIProvider {
  ...
  Future<Response<T>> postMethod<T>(String? url, dynamic body,
    ...
    if (await AppComponentBase.instance.networkManage.isConnected()) {
      try {
        final Response<T> response = await post(url, body,
  ...
  Future<Response<T>> getMethod<T>(String url,
    ...
    if (await AppComponentBase.instance.networkManage.isConnected()) {
      try {
        final Response<T> response = await get(url,
            contentType: contentType,
            headers: headers,
            decoder: decoder,
            query: query);
  ...
  Future<Response<T>> putMethod<T>(String url, dynamic body,
    ...
    if (await AppComponentBase.instance.networkManage.isConnected()) {
      try {
        final Response<T> response = await put(url, body,
            contentType: contentType,
            headers: headers,
            decoder: decoder,
            query: query,
  ...
  Future<Response<T>> patchMethod<T>(String url, dynamic body,
    ...
    if (await AppComponentBase.instance.networkManage.isConnected()) {
      try {
        final Response<T> response = await patch(url, body,
            contentType: contentType,
            headers: headers,
            decoder: decoder,
            query: query,
  ...
  Future<Response<T>> deleteMethod<T>(String url,
    ...
    if (await AppComponentBase.instance.networkManage.isConnected()) {
      try {
        final Response<T> response = await delete(url,
            contentType: contentType,
            headers: headers,
            decoder: decoder,
            query: query);
